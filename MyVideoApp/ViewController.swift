...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func RecordVideo()
    {
        if UIImagePickerController.isSourceTypeAvailable(UIImagePickerControllerSourceType.camera){
            print("captureCideoPressed and camera avalable.")
    ...
    @IBAction func btnRecord(_ sender: UIButton) {
        if txtName.text == ""
        {
            let alert = UIAlertController(title: "NameRequired", message: "Please add name for video", preferredStyle: UIAlertControllerStyle.alert)
    ...
    func moviePlayerDidFinishPlaying(notifcation: NSNotification){
    ...
    func videoEditorContoller(editor: UIVideoEditorController, didSaveEditedVideoToPath editedVideoPath: String){
